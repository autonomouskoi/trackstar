...
<p>
<code>
    <blockquote>{{ .TrackUpdate.Track.Title }} by {{ .TrackUpdate.Track.Artist }}</blockquote>
</code>
...
<p>
<code>
    <blockquote>{{ .TrackUpdate.Track.Artist }} - {{ .TrackUpdate.Track.Title }} ({{ .TrackUpdate.DeckId }})</blockquote>
</code>
